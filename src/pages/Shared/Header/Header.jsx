...
const Header = () => {
  ...
  return (
    <div>
      <div className="navbar shadow-md bg-amber-500 lg:px-10 py-5">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-compact font-semibold dropdown-content mt-7 p-2 shadow bg-base-100 rounded-box w-52"
            >
              <li>
                <ActiveLink
